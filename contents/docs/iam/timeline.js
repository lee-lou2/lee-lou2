...
**🚀 바로가기**
- [https://lou2.kr/docs/project/index/sso/](/docs/project/index/sso/)

### ⭐️⭐️⭐️ GO API 서버 구축
**🔎 상세**
- GO 언어를 이용한 RESTful API 서버
...
- RPC : gRPC
- 메세지 큐 : RabbitMQ
- 외부 API : Google, Twillio, Firebase, Slack, KakaoTalk

### ⭐️⭐️ Notification 서버 구축
**🔎 상세**
- Goroutine 을 이용한 비동기 처리
- Channel 을 통한 내부 큐 활용
- 서비스 : Email, SMS, Push, Slack, KakaoTalk 
...
### ⭐️ AI LLM 활용 및 파인튜닝
**🔎 상세**
- Lora 를 이용한 LLaMA 모델 파인튜닝
- ChatGPT Function call 활용

**🛠️ 기술**
- 파인튜닝 : Lora
- 모델 : LLaMA, Alpaca, GPT4ALL, bark, ChatGPT
...
**🚀 바로가기**
- [https://lou2.kr/docs/project/index/order-by/](/docs/project/index/order-by/)
...
**🚀 바로가기**
- [https://youtube.com/@dingco.lou2](https://youtube.com/@dingco.lou2)

### ⭐️ Playwright, Selenium 를 이용한 웹 자동화
**🔎 상세**
- Playwright, Selenium 을 이용한 웹 자동화
- 테스트 자동화 및 크롤링에 활용

**🛠️ 기술**
- 언어 : Golang
- 라이브러리 : Playwright, Selenium
    `,
...
### ⭐️ 레거시 이전
**🔎 상세**
- 레거시 서비스를 새로운 서비스로 이전(PHP -> Python)
- RDBMS, Kinesis, Message Queue 를 통한 데이터 저장하는 뷰어 Open/Close API

**🛠️ 기술**
- 언어 : Python
- 프레임워크 : Django
- 기타 : MySQL, Kinesis, RabbitMQ

### ⭐️ 데이터베이스 라우팅 세분화
**🔎 상세**
- Read, Write 분리 / Slave 엔드포인트 활용
- 여러 상황들을 고려해 데이터베이스 라우터 수정
- 특정 API만 리플리카를 적용하는 데코레이터 추가
...
**🔎 상세**
- DRM
  - 외부 업체를 통한 NCG DRM 패키징
  - 복호화를 위한 Token 생성 및 발급
- 오디오 관리(ffmpg)
...
### ⭐️⭐️ 챌린지 프로젝트 참여
**🔎 상세**
- 개별 챌린지 개발 : 집중해서 책 읽기, 인생책 고르기, 피드, 챌린지 시작 등
- 챌린지 운영 관련 API 개발
...
- 기타 : Docker, AWS Lambda, CodeCommit
...
**🛠️ 기술**
- 기타 : Docker, AWS CodePipeline, AWS CodeBuild, AWS Beanstalk, AWS ALB, AWS Route53, AWS CloudWatch, Sentry
...
**🛠️ 기술**
- 기타 : Docker, MySQL, Ubuntu

### ⭐️⭐️ 스케쥴링 서비스
**🔎 상세**
- Crontab 을 이용해 정기적인 스크립트 실행
- Google Apps Script 를 이용해 기간 단위 연속된 API 호출
- Celery Beat 를 이용해 Django 서비스 스케쥴링

**🛠️ 기술**
- 언어 : Python
- 기타 : Crontab, Google Apps Script, Celery Beat
...
**🛠️ 기술**
- 기타 : Docker, docker-compose, Jenkins
